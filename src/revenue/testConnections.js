...
function testConnections() {
    return __awaiter(this, void 0, void 0, function () {
        var connector, programs, domains, fiverrLinks, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    connector = affiliateConnector_1.AffiliateConnector.getInstance();
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    // Test Awin connection
                    console.log('Testing Awin connection...');
                    return [4 /*yield*/, connector.getAwinPrograms()];
                case 2:
                    programs = _a.sent();
