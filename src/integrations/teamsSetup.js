...
var TeamsSetup = /** @class */ (function () {
    ...
    TeamsSetup.prototype.cleanupEnvironment = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.graphClient.teams.get()];
                    case 1:
                        teams = _b.sent();
                        _i = 0, _a = teams.value;
                        _b.label = 2;
    ...
    TeamsSetup.prototype.archiveTeam = function (teamId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.graphClient.teams[teamId].archive.post({})];
                    case 1:
                        _a.sent();
    ...
    TeamsSetup.prototype.cleanupLicenses = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.graphClient.users.get()];
                    case 1:
                        users = _b.sent();
                        essentialUsers = ['dean@valueex.ai', 'clark.johnson@divvytech.com', 'cascade@divvytech.com'];
                        _i = 0, _a = users.value;
                        _b.label = 2;
                    case 2:
                        if (!(_i < _a.length)) return [3 /*break*/, 5];
                        user = _a[_i];
                        if (!!essentialUsers.includes(user.userPrincipalName.toLowerCase())) return [3 /*break*/, 4];
    ...
    TeamsSetup.prototype.removeLicenses = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.graphClient.users[userId].assignedLicenses.get()];
                    case 1:
                        licenses = _a.sent();
                        return [4 /*yield*/, this.graphClient.users[userId].assignedLicenses.delete({
                                addLicenses: [],
                                removeLicenses: licenses.value.map(function (l) { return l.skuId; })
                            })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
    ...
    TeamsSetup.prototype.setupNewEnvironment = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.teamsClient.createTeam({
