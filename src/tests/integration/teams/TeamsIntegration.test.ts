...
describe('Teams Integration Tests', () => {
  ...
  describe('End-to-End Flow', () => {
    it('should complete full communication cycle', async () => {
      ...
      // 2. Add test member
      const memberAdded = await channelService.addMember('channel-id', 'test@example.com');
  ...
  describe('Error Handling', () => {
    it('should handle invalid channel gracefully', async () => {
      ...
      const result = await channelService.sendMessage('invalid-channel', 'Test message');
  ...
  describe('Performance', () => {
    it('should maintain acceptable latency', async () => {
      ...
      await channelService.sendMessage('channel-id', 'Performance test message');
