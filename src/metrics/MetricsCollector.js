...
var MetricsCollector = /** @class */ (function () {
    ...
    MetricsCollector.prototype.getMetricHistory = function (metricId) {
        return __awaiter(this, void 0, void 0, function () {
            var now;
            return __generator(this, function (_a) {
                now = new Date();
                return [2 /*return*/, Array.from({ length: 30 }, function (_, i) { return ({
                        id: metricId,
                        name: "Sample Metric ".concat(metricId),
