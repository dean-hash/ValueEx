...
var teamsSetup_1 = require("../src/integrations/teamsSetup");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    setup = new teamsSetup_1.TeamsSetup();
                    console.log('Starting Teams environment cleanup...');
                    return [4 /*yield*/, setup.cleanupEnvironment()];
                case 1:
                    _a.sent();
                    console.log('Cleanup complete');
                    console.log('Setting up new Teams environment...');
                    return [4 /*yield*/, setup.setupNewEnvironment()];
                case 2:
                    _a.sent();
