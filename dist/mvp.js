...
var minimal_1 = require("./services/minimal");
var monitoring_1 = require("./monitoring");
var app = (0, express_1.default)();
app.use(express_1.default.json());
app.use(monitoring_1.requestLogger);
// Initialize services
var teamsService = new minimal_1.TeamsService();
var valueService = new minimal_1.ValueService();
// Initialize Teams integration
teamsService.initialize().catch(console.error);
// Health check endpoint
app.get('/health', function (req, res) {
    res.json((0, monitoring_1.getHealthMetrics)());
});
// API Routes
app.post('/api/meetings/start', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
...
app.post('/api/value/measure', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, valueService.measureValue(product, pattern)];
            case 1:
                metrics = _b.sent();
                res.json(metrics);
                return [3 /*break*/, 3];
