...
export declare class ValueCreationService {
    ...
    constructor(resonanceField: ResonanceFieldService, awinService: AwinService, dynamicsService: DynamicsService, bcService: BusinessCentralService);
    /**
     ...
     */
    calculateIntentMatchValue(product: Product, pattern: DemandPattern, signals: DemandSignal[]): Promise<number>;
    private getCacheKey;
