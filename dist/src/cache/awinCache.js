...
var AwinCache = /** @class */ (function () {
    function AwinCache(ttl) {
        if (ttl === void 0) { ttl = 3600000; }
        // 1 hour default TTL
        this.cache = new Map();
        this.ttl = ttl;
    }
    AwinCache.getInstance = function (ttl) {
        if (!AwinCache.instance) {
            AwinCache.instance = new AwinCache(ttl);
        }
        return AwinCache.instance;
    };
    AwinCache.prototype.get = function (key) {
    ...
    AwinCache.prototype.set = function (key, value) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
    ...
    AwinCache.prototype.delete = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    AwinCache.prototype.clear = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.cache.clear();
                return [2 /*return*/];
