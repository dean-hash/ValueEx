...
describe('DemandSourceManager', () => {
    ...
    test('should normalize weights correctly', () => {
        const weights = manager.sourceWeights;
...
describe('RedditScraper', () => {
    ...
    test('should validate signals correctly', () => {
        ...
        expect(scraper.validateSignal(invalidSignal)).toBe(false);
    });
...
describe('GoogleTrendsScraper', () => {
    ...
    test('should calculate momentum correctly', () => {
        ...
        const momentum = scraper.calculateMomentum(values);
    ...
    test('should calculate seasonality correctly', () => {
        ...
        const seasonality = scraper.calculateSeasonality(values);
    ...
    test('should calculate volatility correctly', () => {
        ...
        const stableVolatility = scraper.calculateVolatility(stableValues);
        const highVolatility = scraper.calculateVolatility(volatileValues);
    ...
    test('should create valid signal from trend metrics', () => {
        ...
        const signal = scraper.createSignal('test-query', mockMetrics, mockRelatedQueries);
        expect(signal).toHaveProperty('id');
        expect(signal).toHaveProperty('confidence.overall');
...
//# sourceMappingURL=demandSources.test.js.map