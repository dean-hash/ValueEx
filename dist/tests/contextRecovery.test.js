...
describe('Context Recovery System', () => {
    ...
    beforeEach(() => {
        ...
        fs.promises.readFile.mockResolvedValue('{"activeTask":{"description":"Test Task"}}');
    ...
    describe('Recovery Process', () => {
        ...
        it('should handle recovery failures gracefully', async () => {
            fs.promises.readdir.mockRejectedValueOnce(new Error('Test Error'));
            const state = await recovery.recoverLatestState();
...
//# sourceMappingURL=contextRecovery.test.js.map