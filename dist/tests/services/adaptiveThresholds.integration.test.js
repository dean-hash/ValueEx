...
describe('Adaptive Thresholds Integration Tests', () => {
    ...
    describe('Data Source Downtime', () => {
        it('should adapt thresholds during source failures', async () => {
            // Mock source failure
            jest
                .spyOn(scraper, 'fetchFromPrimarySource')
        ...
        it('should recover thresholds after source restoration', async () => {
            // Simulate recovery
            jest.spyOn(scraper, 'fetchFromPrimarySource').mockResolvedValue([
                {
                /* mock data */
                },
            ]);
...
//# sourceMappingURL=adaptiveThresholds.integration.test.js.map