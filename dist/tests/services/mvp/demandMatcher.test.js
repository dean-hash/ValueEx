...
describe('DemandMatcher', () => {
    let matcher;
    let signalEnhancer;
    let influenceAnalyzer;
    let intelligence;
    let correlationAnalyzer;
    let demandInference;
    let valueProcessor;
    let contextManager;
    let mockDemandSignal;
    let mockSupplySignal;
    beforeEach(() => {
        // Reset mocks
        jest.clearAllMocks();
    ...
    describe('findMatches', () => {
        it('should return empty array for non-authentic demand', async () => {
            const signal = {
                id: 'test1',
                query: 'test query',
                source: 'test',
        ...
        it('should find matches for authentic demand signals', async () => {
            const signal = {
                id: 'test2',
        ...
        it('should rank matches by value creation potential', async () => {
            const signal = {
                id: 'test3',
    ...
    describe('Intelligence Integration', () => {
        it('should enhance signals with NLP and sentiment analysis', async () => {
            const signal = {
                id: 'test1',
                query: 'sustainable packaging solutions',
                source: 'industry research',
        ...
        it('should find matches using comprehensive intelligence', async () => {
            const signal = {
                id: 'test2',
        ...
        it('should rank matches using weighted value creation factors', async () => {
            const signal = {
                id: 'test3',
            ...
            expect(matches[0].resonanceFactors.valueAlignment).toBeGreaterThan(matches[1].resonanceFactors.valueAlignment);
        });
    });
});
//# sourceMappingURL=demandMatcher.test.js.map