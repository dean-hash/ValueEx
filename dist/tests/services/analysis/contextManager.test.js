...
describe('ContextManager', () => {
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        fs.promises.readdir.mockResolvedValue(['test.ts']);
        fs.promises.readFile.mockResolvedValue('test file content');
        fs.promises.stat.mockResolvedValue({ mtimeMs: Date.now() });
    ...
    describe('Component Analysis', () => {
      ...
      `,
        ...
        beforeEach(() => {
            fs.promises.readFile.mockResolvedValue(testComponent.content);
            fs.promises.stat.mockResolvedValue({ mtimeMs: Date.now() });
        });
