...
const types_1 = require("../services/analysis/types");
/**
...
class IntelligenceViz {
    ...
    getResourceInsights(type, value) {
        ...
        if (value > 0.8)
            ...
            category = 'low';
        return [
            this.performancePatterns[type][category][Math.floor(Math.random() * this.performancePatterns[type][category].length)],
        ];
    }
    /**
...
exports.default = IntelligenceViz;
//# sourceMappingURL=intelligenceViz.js.map